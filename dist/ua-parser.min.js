...
((i, l) => {
  ...
  var M = 500,
    ...
    Hi = function (i, e) {
      if (H(i))
        return (i = Ai(/^\s\s*/, i)), typeof e === n ? i : i.substring(0, M);
    },
    ji = function (i, e) {
      if (i && e)
        for (var t, o, r, a, s, n = 0; n < e.length && !a; ) {
          for (
            var w = e[n], b = e[n + 1], d = (t = 0);
            d < w.length && !a && w[d];
        ...
        i != g &&
          ...
          (s.prototype.toString = function () {
            var i,
              e = w;
            for (i in a)
              typeof this[a[i]] !== n && (e += (e ? " " : w) + this[a[i]]);
            return e || n;
          })),
        O ||
  ...
  function Ui(i, e) {
    if (((i = i || {}), N.call(this, ai), e))
      ...
      for (var t in i)
        this.hasOwnProperty(t) && typeof i[t] !== n && (this[t] = i[t]);
  }
  function Ri(i, e, t, o) {
    return (
      (this.get = function (i) {
  ...
  function P(i, e, t) {
    ...
    return (
      typeof i === c
        ? ((e = _i(i, !0) ? (typeof e === c && (t = e), i) : ((t = i), l)),
          (i = l))
        ...
        ? ((r =
          ...
          (s = e
            ? ((i, e) => {
                ...
                for (t in i)
                  o[t] =
                    r[t] && r[t].length % 2 == 0 ? r[t].concat(i[t]) : i[t];
                return o;
              })(Pi, e)
            : Pi),
          N.call(this, [
  ...
  (P.VERSION = "2.0.2"),
    ...
    typeof exports !== n
      ? ((exports =
          typeof module !== n && module.exports
            ? (module.exports = P)
            : exports).UAParser = P)
